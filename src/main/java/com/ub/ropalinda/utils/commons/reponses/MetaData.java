...
public class MetaData {
    ...
    public MetaData(Object metaData, String message, Status status,
            String devMessage) {
        this.metaData = metaData;
        this.message = message;
        this.status = status;
    ...
    public String toString() {
        return "MetaData{" + "message=" + message + ", status="
                + status + ", devMessage=" + devMessage + ", metaData="
                + metaData + '}';
    }
